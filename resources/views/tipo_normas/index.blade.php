...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('config.tipo_normas.create') }}" class="px-3 py-2 rounded bg-indigo-600 text-white hover:bg-indigo-700">Novo Tipo</a>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 text-right">
                            <div class="inline-flex gap-2">
                                <a href="{{ route('config.tipo_normas.edit', $i) }}" class="px-3 py-1 rounded bg-gray-600 hover:bg-gray-700 text-white text-sm">Editar</a>
                                <form method="POST" action="{{ route('config.tipo_normas.destroy', $i) }}" onsubmit="return confirm('Remover este tipo?');">
                                    @csrf @method('DELETE')
