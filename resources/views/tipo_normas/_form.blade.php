...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    ...
    <div>
        ...
        <input type="text" name="sigla" value="{{ old('sigla', $model->sigla) }}" class="mt-1 block w-full rounded border-gray-300">
...
<div class="mt-6 flex justify-end gap-3">
    <a href="{{ route('config.tipo_normas.index') }}" class="px-3 py-2 rounded border border-gray-300 text-gray-700">Cancelar</a>
