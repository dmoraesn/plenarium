        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('config.tipos-tramitacao.store') }}">
                        @csrf
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="prazo_dias" class="block mt-1 w-full" type="number" name="prazo_dias" :value="old('prazo_dias', 0)" required min="0" />
                            <x-input-error :messages="$errors->get('prazo_dias')" class="mt-2" />
                        </div>

                        <div class="block mt-4">
                            <label for="ativo" class="inline-flex items-center">
                                <input id="ativo" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="ativo" value="1" checked>
