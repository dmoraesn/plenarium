...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    <div class="md:col-span-2">
        ...
        {{-- ✅ A tag de erro @error foi movida para fora do input para melhor estilização --}}
    ...
    <div>
        ...
        <input type="number" name="ordenacao" value="{{ old('ordenacao', $model->ordenacao) }}" class="mt-1 block w-full rounded border-gray-300">
        @error('ordenacao') <p class="text-red-600 text-sm mt-1">{{ $message }}</p> @enderror
    </div>
