...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('config.tipos-expediente.create')); ?>" class="px-3 py-2 rounded bg-indigo-600 text-white hover:bg-indigo-700">Novo Tipo</a>
    </div>
            ...
            <tbody class="divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $itens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="px-4 py-2"><?php echo e($i->ordenacao ?? '—'); ?></td>
                        <td class="px-4 py-2">
                        ...
                        <td class="px-4 py-2 text-right">
                            <div class="inline-flex gap-2">
                                <a href="<?php echo e(route('config.tipos-expediente.edit', $i)); ?>" class="px-3 py-1 rounded bg-gray-600 hover:bg-gray-700 text-white text-sm">Editar</a>
                                <form method="POST" action="<?php echo e(route('config.tipos-expediente.destroy', $i)); ?>" onsubmit="return confirm('Remover este tipo?');">
    ...
    <?php if($itens instanceof \Illuminate\Pagination\LengthAwarePaginator): ?>
        <div class="mt-4"><?php echo e($itens->links()); ?></div>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\plenarium\resources\views/tipo_expediente/index.blade.php ENDPATH**/ ?>