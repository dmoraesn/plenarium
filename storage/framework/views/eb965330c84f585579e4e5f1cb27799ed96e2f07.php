...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Tipos de Norma</h1>
        <a href="<?php echo e(route('config.tipo_normas.create')); ?>" class="px-3 py-2 rounded bg-indigo-600 text-white hover:bg-indigo-700">Novo Tipo</a>
    </div>
            ...
            <tbody class="divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $itens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td class="px-4 py-2"><?php echo e($i->sigla ?? '—'); ?></td>
                        <td class="px-4 py-2">
                        ...
                        <td class="px-4 py-2 text-right">
                            <div class="inline-flex gap-2">
                                <a href="<?php echo e(route('config.tipo_normas.edit', $i)); ?>" class="px-3 py-1 rounded bg-gray-600 hover:bg-gray-700 text-white text-sm">Editar</a>
                                <form method="POST" action="<?php echo e(route('config.tipo_normas.destroy', $i)); ?>" onsubmit="return confirm('Remover este tipo?');">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\plenarium\resources\views/tipo_normas/index.blade.php ENDPATH**/ ?>