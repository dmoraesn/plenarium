            ...
            <div class="mt-2 px-7 py-3">
                ...
                <form id="form-votacao" method="POST">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <button type="submit" formaction="<?php echo e(route('sessoes.ordem.votar', ['sessao' => $sessao, 'item' => ':id'])); ?>" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">
                            Iniciar Votação
                        </button>
...
</div><?php /**PATH C:\xampp\htdocs\plenarium\resources\views/sessoes/ordem/_votar-modal.blade.php ENDPATH**/ ?>